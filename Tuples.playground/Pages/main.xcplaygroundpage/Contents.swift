 ...
 */
var person = (name: "Miranda", age: 21)
 ...
 */
var someone = (name: "Kudzanay", age: 28)
 ...
 */
print("Happe \(someone.age) birthday, \(someone.name)!")
 ...
 */
//No, you cannot change human's age because human is a constant.
